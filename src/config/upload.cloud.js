...
const storage = new CloudinaryStorage({
  cloudinary,
  params: {
    folder: "avatar", // define folder lưu hình, nếu cloudinary không có folder này thì sẽ tạo mới folder này
    format: async (req, file) => {
      // define những format file cho phép upload lên Cloud
      ...
      if (validFormats.includes(fileFormat)) return fileFormat;
